# P4-AU05: Audio Reactive Effects

> **Task ID:** `P4-AU05`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vaudio_reactive/audio_reactive_effects.py`)  
> **Class:** `AudioKaleidoscope`  
> **Phase:** Phase 4  
> **Status:** ⬜ Todo  

## Mission Context

Port the `AudioKaleidoscope` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Audio collection and is essential for complete feature parity.
