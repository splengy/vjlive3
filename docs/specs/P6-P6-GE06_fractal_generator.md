# P6-GE06: fractal_generator

> **Task ID:** `P6-GE06`  
> **Priority:** P0 (Critical)  
> **Source:** vjlive (`plugins/vcore/fractal_generator.py`)  
...
Port the `FractalGenerator` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Generator collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/fractal_generator.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/fractal_generator.py`
...
- Original source: `vjlive/plugins/vcore/fractal_generator.py`
