# P4-AU07: raymarched_scenes

> **Task ID:** `P4-AU07`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vshadertoy_extra/raymarched_scenes.py`)  
...
Port the `AudioReactiveRaymarchedScenes` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Audio collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vshadertoy_extra/raymarched_scenes.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vshadertoy_extra/raymarched_scenes.py`
...
- Original source: `VJlive-2/plugins/vshadertoy_extra/raymarched_scenes.py`
