...
Port the `MLStyleGLEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Quantum/AI collection and is essential for complete feature parity.
