# P7-VE78: vimana_hyperion_ultimate
...
Port the `VimanaHyperionUltimate` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
