...
> **Source:** vjlive (`plugins/vcore/color_grade.py`)  
...
Port the `ColorGradeEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/color_grade.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/color_grade.py`
...
- Original source: `vjlive/plugins/vcore/color_grade.py`
