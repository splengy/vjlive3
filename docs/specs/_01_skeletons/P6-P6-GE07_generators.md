...
Port the `OscEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Generator collection and is essential for complete feature parity.
