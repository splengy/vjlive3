...
> **Source:** vjlive (`plugins/vcore/analog_tv.py`)  
...
Port the `AnalogTVEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the V-Effect collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/analog_tv.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/analog_tv.py`
...
- Original source: `vjlive/plugins/vcore/analog_tv.py`
