...
Port the `Particle3DSystem` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Particle/3D collection and is essential for complete feature parity.
