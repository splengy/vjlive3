# P3-VD53: Depth Liquid Refraction

> **Task ID:** `P3-VD53`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vdepth/depth_liquid_refraction.py`)  
> **Class:** `DepthLiquidRefractionEffect`  
> **Phase:** Phase 3  
> **Status:** ⬜ Todo  

## Mission Context

Port the `DepthLiquidRefractionEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Depth collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vdepth/depth_liquid_refraction.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vdepth/depth_liquid_refraction.py`
...
- Original source: `VJlive-2/plugins/vdepth/depth_liquid_refraction.py`
