# P5-DM02: bad_trip_datamosh

> **Task ID:** `P5-DM02`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vdatamosh/bad_trip_datamosh.py`)  
...
Port the `BadTripDatamoshEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Datamosh collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vdatamosh/bad_trip_datamosh.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vdatamosh/bad_trip_datamosh.py`
...
- Original source: `VJlive-2/plugins/vdatamosh/bad_trip_datamosh.py`
