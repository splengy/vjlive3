# P4-AU06: cosmic_tunnel_datamosh

> **Task ID:** `P4-AU06`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vdatamosh/cosmic_tunnel_datamosh.py`)  
...
Port the `CosmicTunnelDatamoshEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Audio collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vdatamosh/cosmic_tunnel_datamosh.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vdatamosh/cosmic_tunnel_datamosh.py`
...
- Original source: `VJlive-2/plugins/vdatamosh/cosmic_tunnel_datamosh.py`
