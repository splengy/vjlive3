...
> **Source:** vjlive (`plugins/vcore/generators.py`)  
...
Port the `GradientEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Generator collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/generators.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/generators.py`
...
- Original source: `vjlive/plugins/vcore/generators.py`
