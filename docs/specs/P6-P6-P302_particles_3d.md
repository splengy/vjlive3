# P6-P302: particles_3d

> **Task ID:** `P6-P302`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vparticles/particles_3d.py`)  
...
Port the `AdvancedParticle3DSystem` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Particle/3D collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vparticles/particles_3d.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vparticles/particles_3d.py`
...
- Original source: `VJlive-2/plugins/vparticles/particles_3d.py`
