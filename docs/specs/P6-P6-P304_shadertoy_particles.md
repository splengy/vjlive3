# P6-P304: shadertoy_particles

> **Task ID:** `P6-P304`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vshadertoy_extra/shadertoy_particles.py`)  
> **Class:** `ShadertoyParticles`  
> **Phase:** Phase 6  
> **Status:** ⬜ Todo  

## Mission Context

Port the `ShadertoyParticles` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Particle/3D collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vshadertoy_extra/shadertoy_particles.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vshadertoy_extra/shadertoy_particles.py`
...
- Original source: `VJlive-2/plugins/vshadertoy_extra/shadertoy_particles.py`
