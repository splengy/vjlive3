...
> **Class:** `ProjectionMappingEffect`  
> **Phase:** Phase 7  
> **Status:** ⬜ Todo  

## Mission Context

Port the `ProjectionMappingEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/geometry.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/geometry.py`
...
- Original source: `vjlive/plugins/vcore/geometry.py`
