...
Port the `ChromaKeyEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/chroma_key.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/chroma_key.py`
...
- Original source: `vjlive/plugins/vcore/chroma_key.py`
