...
Port the `WarholQuadEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vstyle/pop_art_effects.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vstyle/pop_art_effects.py`
...
- Original source: `VJlive-2/plugins/vstyle/pop_art_effects.py`
