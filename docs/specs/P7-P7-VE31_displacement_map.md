# P7-VE31: displacement_map

> **Task ID:** `P7-VE31`  
> **Priority:** P0 (Critical)  
> **Source:** vjlive (`plugins/vcore/displacement_map.py`)  
...
Port the `DisplacementMapEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/displacement_map.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/displacement_map.py`
...
- Original source: `vjlive/plugins/vcore/displacement_map.py`
