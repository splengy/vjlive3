...
## Mission Context
Port the `VerticalWaveEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Other collection and is essential for complete feature parity.
...
|--------------------|--------------|----------------|--------------------------------------|
| direction          | 0-10         | 0.0-1.0        | Wave direction (3.3 = vertical)      |
...
> "The vertical wave effect embodies the golden ratio's harmony in its frequency and decay parameters."
