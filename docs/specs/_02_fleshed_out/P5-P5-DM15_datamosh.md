...
> **Source:** vjlive (`plugins/vcore/datamosh.py`)  
> **Class:** `FrameHoldEffect`  
> **Phase:** Phase 5  
> **Status:** ⬜ Todo  

## Mission Context

Port the `FrameHoldEffect` effect from `vjlive` codebase into VJLive3's clean architecture. This plugin is part of the Datamosh collection and is essential for complete feature parity.
...
**Original Location:** `vjlive/plugins/vcore/datamosh.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `vjlive/plugins/vcore/datamosh.py`
...
- Original source: `vjlive/plugins/vcore/datamosh.py`
