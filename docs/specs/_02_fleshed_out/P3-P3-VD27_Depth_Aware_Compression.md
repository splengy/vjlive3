...
> **Source:** VJlive-2 (`plugins/vdepth/depth_aware_compression.py`)  
...
Port the `DepthAwareCompressionEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Depth collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vdepth/depth_aware_compression.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vdepth/depth_aware_compression.py`
...
- Original source: `VJlive-2/plugins/vdepth/depth_aware_compression.py`
