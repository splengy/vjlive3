# P3-VD74: ml_gpu_effects

> **Task ID:** `P3-VD74`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vml/ml_gpu_effects.py`)  
> **Class:** `MLDepthEstimationEffect`  
> **Phase:** Phase 3  
> **Status:** ⬜ Todo  

## Mission Context

Port the `MLDepthEstimationEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Depth collection and is essential for complete feature parity.
