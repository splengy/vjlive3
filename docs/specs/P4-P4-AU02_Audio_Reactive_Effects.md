# P4-AU02: Audio Reactive Effects
...
Port the `AudioParticleSystem` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Audio collection and is essential for complete feature parity.
