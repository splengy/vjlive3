# P3-VD70: Depth Video Projection

> **Task ID:** `P3-VD70`  
> **Priority:** P0 (Critical)  
> **Source:** VJlive-2 (`plugins/vdepth/depth_video_projection.py`)  
> **Class:** `DepthVideoProjectionEffect`  
> **Phase:** Phase 3  
> **Status:** ⬜ Todo  

## Mission Context

Port the `DepthVideoProjectionEffect` effect from `VJlive-2` codebase into VJLive3's clean architecture. This plugin is part of the Depth collection and is essential for complete feature parity.
...
**Original Location:** `VJlive-2/plugins/vdepth/depth_video_projection.py`  
**Description:** No description available

### Porting Strategy

1. Study the original implementation in `VJlive-2/plugins/vdepth/depth_video_projection.py`
...
- Original source: `VJlive-2/plugins/vdepth/depth_video_projection.py`
