"""Tests for P6-QC12: QuantumConsciousnessExplorerPlugin."""
import pytest
...
from vjlive3.plugins.quantum_consciousness_explorer import QuantumConsciousnessExplorerPlugin, METADATA
...
def plugin():
    ...
    _mock_gl.glCreateProgram.return_value = 99; _mock_gl.glGenVertexArrays.return_value = 44
    _mock_gl.glGenTextures.return_value = 55; _mock_gl.glGenFramebuffers.return_value = 51
    return QuantumConsciousnessExplorerPlugin()
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Quantum Consciousness Explorer'
    assert len(m["parameters"]) == 8

@patch('vjlive3.plugins.quantum_consciousness_explorer.gl', _mock_gl)
...
@patch('vjlive3.plugins.quantum_consciousness_explorer.gl', _mock_gl)
@patch('vjlive3.plugins.quantum_consciousness_explorer.hasattr')
