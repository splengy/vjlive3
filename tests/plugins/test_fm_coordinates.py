"""Tests for P6-GE16: FMCoordinatesPlugin."""
import pytest
...
from vjlive3.plugins.fm_coordinates import FMCoordinatesPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Fm Coordinates'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.fm_coordinates.gl', _mock_gl)
...
@patch('vjlive3.plugins.fm_coordinates.gl', _mock_gl)
@patch('vjlive3.plugins.fm_coordinates.hasattr')
