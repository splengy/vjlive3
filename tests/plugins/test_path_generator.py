# """Tests for P6-GE14: PathGeneratorPlugin."""
import pytest
...
# from vjlive3.plugins.path_generator import PathGeneratorPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Path Generator'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.path_generator.gl', _mock_gl)
...
@patch('vjlive3.plugins.path_generator.gl', _mock_gl)
@patch('vjlive3.plugins.path_generator.hasattr')
