"""Tests for P7-VE73: AdaptiveContrastPlugin."""
import pytest
...
from vjlive3.plugins.adaptive_contrast import AdaptiveContrastPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Adaptive Contrast'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.adaptive_contrast.gl', _gl)
...
@patch('vjlive3.plugins.adaptive_contrast.gl', _gl)
@patch('vjlive3.plugins.adaptive_contrast.hasattr')
