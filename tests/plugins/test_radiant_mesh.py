"""Tests for P6-P305: RadiantMeshPlugin."""
import pytest
...
from vjlive3.plugins.radiant_mesh import RadiantMeshPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Radiant Mesh'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.radiant_mesh.gl', _mock_gl)
...
@patch('vjlive3.plugins.radiant_mesh.gl', _mock_gl)
@patch('vjlive3.plugins.radiant_mesh.hasattr')
