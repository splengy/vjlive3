"""Tests for P6-GE15: HarmonicPatternsPlugin."""
import pytest
...
from vjlive3.plugins.harmonic_patterns import HarmonicPatternsPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Harmonic Patterns'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.harmonic_patterns.gl', _mock_gl)
...
@patch('vjlive3.plugins.harmonic_patterns.gl', _mock_gl)
@patch('vjlive3.plugins.harmonic_patterns.hasattr')
