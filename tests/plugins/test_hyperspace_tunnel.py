"""Tests for P7-VE45: HyperspaceTunnelPlugin."""
import pytest
...
from vjlive3.plugins.hyperspace_tunnel import HyperspaceTunnelPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Hyperspace Tunnel'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.hyperspace_tunnel.gl', _gl)
...
@patch('vjlive3.plugins.hyperspace_tunnel.gl', _gl)
@patch('vjlive3.plugins.hyperspace_tunnel.hasattr')
