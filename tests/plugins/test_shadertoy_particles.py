"""Tests for P6-P304: ShadertoyParticlesPlugin."""
import pytest
...
from vjlive3.plugins.shadertoy_particles import ShadertoyParticlesPlugin, METADATA
...
def plugin():
    ...
    _mock_gl.glCreateProgram.return_value = 99; _mock_gl.glGenVertexArrays.return_value = 44
    _mock_gl.glGenTextures.return_value = 55; _mock_gl.glGenFramebuffers.return_value = 51
    return ShadertoyParticlesPlugin()
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Shadertoy Particles'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.shadertoy_particles.gl', _mock_gl)
...
@patch('vjlive3.plugins.shadertoy_particles.gl', _mock_gl)
@patch('vjlive3.plugins.shadertoy_particles.hasattr')
