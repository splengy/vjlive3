"""Tests for P7-VE81: SpectrumAnalyzerPlugin."""
import pytest
...
from vjlive3.plugins.spectrum_analyzer import SpectrumAnalyzerPlugin, METADATA
...
def test_metadata(plugin): m=plugin.get_metadata();assert m["name"]=="Spectrum Analyzer";assert len(m["parameters"])==6
@patch('vjlive3.plugins.spectrum_analyzer.gl',_g)
...
@patch('vjlive3.plugins.spectrum_analyzer.gl',_g)
@patch('vjlive3.plugins.spectrum_analyzer.hasattr')
