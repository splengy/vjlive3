"""Tests for P7-VE20: PosterizePlugin."""
import pytest
...
from vjlive3.plugins.posterize_effect import PosterizePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Posterize Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.posterize_effect.gl', _gl)
...
@patch('vjlive3.plugins.posterize_effect.gl', _gl)
@patch('vjlive3.plugins.posterize_effect.hasattr')
