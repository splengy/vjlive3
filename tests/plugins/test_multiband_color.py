"""Tests for P7-VE69: MultibandColorPlugin."""
import pytest
...
from vjlive3.plugins.multiband_color import MultibandColorPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Multiband Color'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.multiband_color.gl', _gl)
...
@patch('vjlive3.plugins.multiband_color.gl', _gl)
@patch('vjlive3.plugins.multiband_color.hasattr')
