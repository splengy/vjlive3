"""Tests for P7-VE29: ColorGradePlugin."""
import pytest
...
from vjlive3.plugins.color_grade2 import ColorGradePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Color Grade2'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.color_grade2.gl', _gl)
...
@patch('vjlive3.plugins.color_grade2.gl', _gl)
@patch('vjlive3.plugins.color_grade2.hasattr')
