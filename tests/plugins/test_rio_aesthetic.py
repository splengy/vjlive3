"""Tests for P7-VE76: RioAestheticPlugin."""
import pytest
...
from vjlive3.plugins.rio_aesthetic import RioAestheticPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Rio Aesthetic'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.rio_aesthetic.gl', _gl)
...
@patch('vjlive3.plugins.rio_aesthetic.gl', _gl)
@patch('vjlive3.plugins.rio_aesthetic.hasattr')
