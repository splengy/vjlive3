"""Tests for P6-GE10: GradientPlugin."""
import pytest
...
from vjlive3.plugins.gradient_effect import GradientPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Gradient Effect'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.gradient_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.gradient_effect.gl', _mock_gl)
@patch('vjlive3.plugins.gradient_effect.hasattr')
