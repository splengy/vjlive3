"""Tests for P7-VE49: MilkdropPlugin."""
import pytest
...
from vjlive3.plugins.milkdrop import MilkdropPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Milkdrop'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.milkdrop.gl', _gl)
...
@patch('vjlive3.plugins.milkdrop.gl', _gl)
@patch('vjlive3.plugins.milkdrop.hasattr')
