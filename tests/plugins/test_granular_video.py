"""Tests for P6-GE18: GranularVideoPlugin."""
import pytest
...
from vjlive3.plugins.granular_video import GranularVideoPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Granular Video'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.granular_video.gl', _mock_gl)
...
@patch('vjlive3.plugins.granular_video.gl', _mock_gl)
@patch('vjlive3.plugins.granular_video.hasattr')
