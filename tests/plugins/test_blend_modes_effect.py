"""Tests for P7-VE18: BlendModePlugin."""
import pytest
...
from vjlive3.plugins.blend_modes_effect import BlendModePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Blend Modes Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.blend_modes_effect.gl', _gl)
...
@patch('vjlive3.plugins.blend_modes_effect.gl', _gl)
@patch('vjlive3.plugins.blend_modes_effect.hasattr')
