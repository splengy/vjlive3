"""Tests for P7-VE71: SolarizePlugin."""
import pytest
...
from vjlive3.plugins.solarize_effect import SolarizePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Solarize Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.solarize_effect.gl', _gl)
...
@patch('vjlive3.plugins.solarize_effect.gl', _gl)
@patch('vjlive3.plugins.solarize_effect.hasattr')
