"""Tests for P7-VE22: SaturatePlugin."""
import pytest
...
from vjlive3.plugins.saturate_effect import SaturatePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Saturate Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.saturate_effect.gl', _gl)
...
@patch('vjlive3.plugins.saturate_effect.gl', _gl)
@patch('vjlive3.plugins.saturate_effect.hasattr')
