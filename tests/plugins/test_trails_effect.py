"""Tests for P6-QC13: TrailsPlugin."""
import pytest
...
from vjlive3.plugins.trails_effect import TrailsPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Trails Effect'
    assert len(m["parameters"]) == 8

@patch('vjlive3.plugins.trails_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.trails_effect.gl', _mock_gl)
@patch('vjlive3.plugins.trails_effect.hasattr')
