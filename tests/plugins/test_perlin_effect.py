"""Tests for P6-GE13: PerlinPlugin."""
import pytest
...
from vjlive3.plugins.perlin_effect import PerlinPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Perlin Effect'
    assert len(m["parameters"]) == 11

@patch('vjlive3.plugins.perlin_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.perlin_effect.gl', _mock_gl)
@patch('vjlive3.plugins.perlin_effect.hasattr')
