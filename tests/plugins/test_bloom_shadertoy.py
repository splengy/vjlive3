"""Tests for P7-VE16: BloomShadertoyPlugin."""
import pytest
...
from vjlive3.plugins.bloom_shadertoy import BloomShadertoyPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Bloom Shadertoy'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.bloom_shadertoy.gl', _gl)
...
@patch('vjlive3.plugins.bloom_shadertoy.gl', _gl)
@patch('vjlive3.plugins.bloom_shadertoy.hasattr')
