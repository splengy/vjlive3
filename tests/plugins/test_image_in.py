"""Tests for P7-VE61: ImageInPlugin."""
import pytest
...
from vjlive3.plugins.image_in import ImageInPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Image In'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.image_in.gl', _gl)
...
@patch('vjlive3.plugins.image_in.gl', _gl)
@patch('vjlive3.plugins.image_in.hasattr')
