"""Tests for P7-VE08: FeedbackPlugin."""
import pytest
...
from vjlive3.plugins.feedback_effect import FeedbackPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Feedback Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.feedback_effect.gl', _gl)
...
@patch('vjlive3.plugins.feedback_effect.gl', _gl)
@patch('vjlive3.plugins.feedback_effect.hasattr')
