"""Tests for P7-VE14: InfiniteFeedbackPlugin."""
import pytest
...
from vjlive3.plugins.infinite_feedback import InfiniteFeedbackPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Infinite Feedback'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.infinite_feedback.gl', _gl)
...
@patch('vjlive3.plugins.infinite_feedback.gl', _gl)
@patch('vjlive3.plugins.infinite_feedback.hasattr')
