"""Tests for P7-VE75: DelayZoomPlugin."""
import pytest
...
from vjlive3.plugins.delay_zoom import DelayZoomPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Delay Zoom'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.delay_zoom.gl', _gl)
...
@patch('vjlive3.plugins.delay_zoom.gl', _gl)
@patch('vjlive3.plugins.delay_zoom.hasattr')
