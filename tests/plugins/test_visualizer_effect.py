"""Tests for P7-VE80: VisualizerPlugin."""
import pytest
...
from vjlive3.plugins.visualizer_effect import VisualizerPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Visualizer Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.visualizer_effect.gl', _gl)
...
@patch('vjlive3.plugins.visualizer_effect.gl', _gl)
@patch('vjlive3.plugins.visualizer_effect.hasattr')
