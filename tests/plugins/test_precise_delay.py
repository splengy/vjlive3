"""Tests for P7-VE64: PreciseDelayPlugin."""
import pytest
...
from vjlive3.plugins.precise_delay import PreciseDelayPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Precise Delay'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.precise_delay.gl', _gl)
...
@patch('vjlive3.plugins.precise_delay.gl', _gl)
@patch('vjlive3.plugins.precise_delay.hasattr')
