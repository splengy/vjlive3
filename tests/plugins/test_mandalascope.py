"""Tests for P7-VE36: MandalascopePlugin."""
import pytest
...
from vjlive3.plugins.mandalascope import MandalascopePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Mandalascope'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.mandalascope.gl', _gl)
...
@patch('vjlive3.plugins.mandalascope.gl', _gl)
@patch('vjlive3.plugins.mandalascope.hasattr')
