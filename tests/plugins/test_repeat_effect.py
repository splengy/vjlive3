"""Tests for P7-VE40: RepeatPlugin."""
import pytest
...
from vjlive3.plugins.repeat_effect import RepeatPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Repeat Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.repeat_effect.gl', _gl)
...
@patch('vjlive3.plugins.repeat_effect.gl', _gl)
@patch('vjlive3.plugins.repeat_effect.hasattr')
