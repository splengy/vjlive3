"""Tests for P7-VE66: SyncEaterPlugin."""
import pytest
...
from vjlive3.plugins.sync_eater import SyncEaterPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Sync Eater'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.sync_eater.gl', _gl)
...
@patch('vjlive3.plugins.sync_eater.gl', _gl)
@patch('vjlive3.plugins.sync_eater.hasattr')
