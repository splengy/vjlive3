"""Tests for P7-VE59: RuttEtraPlugin."""
import pytest
...
from vjlive3.plugins.rutt_etra import RuttEtraPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Rutt Etra'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.rutt_etra.gl', _gl)
...
@patch('vjlive3.plugins.rutt_etra.gl', _gl)
@patch('vjlive3.plugins.rutt_etra.hasattr')
