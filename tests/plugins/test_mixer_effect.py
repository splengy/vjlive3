...
from vjlive3.plugins.mixer_effect import MixerPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Mixer Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.mixer_effect.gl', _gl)
...
@patch('vjlive3.plugins.mixer_effect.gl', _gl)
@patch('vjlive3.plugins.mixer_effect.hasattr')
