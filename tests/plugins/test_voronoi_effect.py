"""Tests for P6-GE09: VoronoiPlugin."""
import pytest
...
from vjlive3.plugins.voronoi_effect import VoronoiPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Voronoi Effect'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.voronoi_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.voronoi_effect.gl', _mock_gl)
@patch('vjlive3.plugins.voronoi_effect.hasattr')
