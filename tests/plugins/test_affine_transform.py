"""Tests for P7-VE63: AffineTransformPlugin."""
import pytest
...
from vjlive3.plugins.affine_transform import AffineTransformPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Affine Transform'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.affine_transform.gl', _gl)
...
@patch('vjlive3.plugins.affine_transform.gl', _gl)
@patch('vjlive3.plugins.affine_transform.hasattr')
