"""Tests for P7-VE62: CoordinateFolderPlugin."""
import pytest
...
from vjlive3.plugins.coordinate_folder import CoordinateFolderPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Coordinate Folder'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.coordinate_folder.gl', _gl)
...
@patch('vjlive3.plugins.coordinate_folder.gl', _gl)
@patch('vjlive3.plugins.coordinate_folder.hasattr')
