"""Tests for P7-VE60: VideoOutPlugin."""
import pytest
...
from vjlive3.plugins.video_out import VideoOutPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Video Out'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.video_out.gl', _gl)
...
@patch('vjlive3.plugins.video_out.gl', _gl)
@patch('vjlive3.plugins.video_out.hasattr')
