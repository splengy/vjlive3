"""Tests for P7-VE12: ScanlinesPlugin."""
import pytest
...
from vjlive3.plugins.scanlines_effect import ScanlinesPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Scanlines Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.scanlines_effect.gl', _gl)
...
@patch('vjlive3.plugins.scanlines_effect.gl', _gl)
@patch('vjlive3.plugins.scanlines_effect.hasattr')
