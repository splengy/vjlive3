...
from vjlive3.plugins.scale_effect import ScalePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Scale Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.scale_effect.gl', _gl)
...
@patch('vjlive3.plugins.scale_effect.gl', _gl)
@patch('vjlive3.plugins.scale_effect.hasattr')
