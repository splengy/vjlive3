"""Tests for P6-GE12: PlasmaPlugin."""
import pytest
...
from vjlive3.plugins.plasma_effect import PlasmaPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Plasma Effect'
    assert len(m["parameters"]) == 11

@patch('vjlive3.plugins.plasma_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.plasma_effect.gl', _mock_gl)
@patch('vjlive3.plugins.plasma_effect.hasattr')
