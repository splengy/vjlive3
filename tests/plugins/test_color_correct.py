"""Tests for P7-VE28: ColorCorrectPlugin."""
import pytest
...
from vjlive3.plugins.color_correct import ColorCorrectPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Color Correct'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.color_correct.gl', _gl)
...
@patch('vjlive3.plugins.color_correct.gl', _gl)
@patch('vjlive3.plugins.color_correct.hasattr')
