"""Tests for P6-QC06: TravelingAvatarPlugin."""
import pytest
...
from vjlive3.plugins.traveling_avatar import TravelingAvatarPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Traveling Avatar'
    assert len(m["parameters"]) == 8

@patch('vjlive3.plugins.traveling_avatar.gl', _mock_gl)
...
@patch('vjlive3.plugins.traveling_avatar.gl', _mock_gl)
@patch('vjlive3.plugins.traveling_avatar.hasattr')
