"""Tests for P7-VE13: VignettePlugin."""
import pytest
...
from vjlive3.plugins.vignette_effect import VignettePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Vignette Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.vignette_effect.gl', _gl)
...
@patch('vjlive3.plugins.vignette_effect.gl', _gl)
@patch('vjlive3.plugins.vignette_effect.hasattr')
