"""Tests for P7-VE24: BrightnessPlugin."""
import pytest
...
from vjlive3.plugins.brightness_effect import BrightnessPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Brightness Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.brightness_effect.gl', _gl)
...
@patch('vjlive3.plugins.brightness_effect.gl', _gl)
@patch('vjlive3.plugins.brightness_effect.hasattr')
