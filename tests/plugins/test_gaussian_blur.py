"""Tests for P7-VE68: GaussianBlurPlugin."""
import pytest
...
from vjlive3.plugins.gaussian_blur import GaussianBlurPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Gaussian Blur'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.gaussian_blur.gl', _gl)
...
@patch('vjlive3.plugins.gaussian_blur.gl', _gl)
@patch('vjlive3.plugins.gaussian_blur.hasattr')
