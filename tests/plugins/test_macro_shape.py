"""Tests for P6-GE17: MacroShapePlugin."""
import pytest
...
from vjlive3.plugins.macro_shape import MacroShapePlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Macro Shape'
    assert len(m["parameters"]) == 11

@patch('vjlive3.plugins.macro_shape.gl', _mock_gl)
...
@patch('vjlive3.plugins.macro_shape.gl', _mock_gl)
@patch('vjlive3.plugins.macro_shape.hasattr')
