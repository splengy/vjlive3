"""Tests for P7-VE54: WarholQuadPlugin."""
import pytest
...
from vjlive3.plugins.warhol_quad import WarholQuadPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Warhol Quad'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.warhol_quad.gl', _gl)
...
@patch('vjlive3.plugins.warhol_quad.gl', _gl)
@patch('vjlive3.plugins.warhol_quad.hasattr')
