"""Tests for P7-VE39: PixelatePlugin."""
import pytest
...
from vjlive3.plugins.pixelate_effect import PixelatePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Pixelate Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.pixelate_effect.gl', _gl)
...
@patch('vjlive3.plugins.pixelate_effect.gl', _gl)
@patch('vjlive3.plugins.pixelate_effect.hasattr')
