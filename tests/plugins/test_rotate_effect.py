"""Tests for P7-VE37: RotatePlugin."""
import pytest
...
from vjlive3.plugins.rotate_effect import RotatePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Rotate Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.rotate_effect.gl', _gl)
...
@patch('vjlive3.plugins.rotate_effect.gl', _gl)
@patch('vjlive3.plugins.rotate_effect.hasattr')
