"""Tests for P6-GE19: ResonantGeometryPlugin."""
import pytest
...
from vjlive3.plugins.resonant_geometry import ResonantGeometryPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Resonant Geometry'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.resonant_geometry.gl', _mock_gl)
...
@patch('vjlive3.plugins.resonant_geometry.gl', _mock_gl)
@patch('vjlive3.plugins.resonant_geometry.hasattr')
