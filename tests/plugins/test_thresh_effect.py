"""Tests for P7-VE26: ThreshPlugin."""
import pytest
...
from vjlive3.plugins.thresh_effect import ThreshPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Thresh Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.thresh_effect.gl', _gl)
...
@patch('vjlive3.plugins.thresh_effect.gl', _gl)
@patch('vjlive3.plugins.thresh_effect.hasattr')
