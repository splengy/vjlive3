"""Tests for P7-VE02: HorizontalWavePlugin."""
import pytest
...
from vjlive3.plugins.horizontal_wave import HorizontalWavePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Horizontal Wave'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.horizontal_wave.gl', _gl)
...
@patch('vjlive3.plugins.horizontal_wave.gl', _gl)
@patch('vjlive3.plugins.horizontal_wave.hasattr')
