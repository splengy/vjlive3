"""Tests for P7-VE04: RipplePlugin."""
import pytest
...
from vjlive3.plugins.ripple_effect import RipplePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Ripple Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.ripple_effect.gl', _gl)
...
@patch('vjlive3.plugins.ripple_effect.gl', _gl)
@patch('vjlive3.plugins.ripple_effect.hasattr')
