"""Tests for P7-VE35: FluidSimPlugin."""
import pytest
...
from vjlive3.plugins.fluid_sim import FluidSimPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Fluid Sim'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.fluid_sim.gl', _gl)
...
@patch('vjlive3.plugins.fluid_sim.gl', _gl)
@patch('vjlive3.plugins.fluid_sim.hasattr')
