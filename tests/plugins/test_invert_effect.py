"""Tests for P7-VE25: InvertPlugin."""
import pytest
...
from vjlive3.plugins.invert_effect import InvertPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Invert Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.invert_effect.gl', _gl)
...
@patch('vjlive3.plugins.invert_effect.gl', _gl)
@patch('vjlive3.plugins.invert_effect.hasattr')
