"""Tests for P6-P303: Particle3DPlugin."""
import pytest
...
from vjlive3.plugins.particle_3d import Particle3DPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Particle 3D'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.particle_3d.gl', _mock_gl)
...
@patch('vjlive3.plugins.particle_3d.gl', _mock_gl)
@patch('vjlive3.plugins.particle_3d.hasattr')
