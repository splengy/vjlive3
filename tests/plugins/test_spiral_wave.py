"""Tests for P7-VE05: SpiralWavePlugin."""
import pytest
...
from vjlive3.plugins.spiral_wave import SpiralWavePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Spiral Wave'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.spiral_wave.gl', _gl)
...
@patch('vjlive3.plugins.spiral_wave.gl', _gl)
@patch('vjlive3.plugins.spiral_wave.hasattr')
