...
from vjlive3.plugins.ascii_effect2 import ASCIIPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Ascii Effect2'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.ascii_effect2.gl', _gl)
...
@patch('vjlive3.plugins.ascii_effect2.gl', _gl)
@patch('vjlive3.plugins.ascii_effect2.hasattr')
