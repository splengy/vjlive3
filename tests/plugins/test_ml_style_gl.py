"""Tests for P6-QC09: MLStylePlugin."""
import pytest
...
from vjlive3.plugins.ml_style_gl import MLStylePlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Ml Style Gl'
    assert len(m["parameters"]) == 8

@patch('vjlive3.plugins.ml_style_gl.gl', _mock_gl)
...
@patch('vjlive3.plugins.ml_style_gl.gl', _mock_gl)
@patch('vjlive3.plugins.ml_style_gl.hasattr')
