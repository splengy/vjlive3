"""Tests for P7-VE74: SpatialEchoPlugin."""
import pytest
...
from vjlive3.plugins.spatial_echo import SpatialEchoPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Spatial Echo'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.spatial_echo.gl', _gl)
...
@patch('vjlive3.plugins.spatial_echo.gl', _gl)
@patch('vjlive3.plugins.spatial_echo.hasattr')
