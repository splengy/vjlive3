"""Tests for P7-VE10: BlendMultPlugin."""
import pytest
...
from vjlive3.plugins.blend_mult import BlendMultPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Blend Mult'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.blend_mult.gl', _gl)
...
@patch('vjlive3.plugins.blend_mult.gl', _gl)
@patch('vjlive3.plugins.blend_mult.hasattr')
