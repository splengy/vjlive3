"""Tests for P7-VE70: HDRToneMapPlugin."""
import pytest
...
from vjlive3.plugins.hdr_tonemap import HDRToneMapPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Hdr Tonemap'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.hdr_tonemap.gl', _gl)
...
@patch('vjlive3.plugins.hdr_tonemap.gl', _gl)
@patch('vjlive3.plugins.hdr_tonemap.hasattr')
