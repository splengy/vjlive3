"""Tests for P7-VE72: ResonantBlurPlugin."""
import pytest
...
from vjlive3.plugins.resonant_blur import ResonantBlurPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Resonant Blur'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.resonant_blur.gl', _gl)
...
@patch('vjlive3.plugins.resonant_blur.gl', _gl)
@patch('vjlive3.plugins.resonant_blur.hasattr')
