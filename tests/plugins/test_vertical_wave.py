"""Tests for P7-VE03: VerticalWavePlugin."""
import pytest
...
from vjlive3.plugins.vertical_wave import VerticalWavePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Vertical Wave'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.vertical_wave.gl', _gl)
...
@patch('vjlive3.plugins.vertical_wave.gl', _gl)
@patch('vjlive3.plugins.vertical_wave.hasattr')
