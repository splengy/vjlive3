"""Tests for P7-VE46: LivingFractalPlugin."""
import pytest
...
from vjlive3.plugins.living_fractal import LivingFractalPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Living Fractal'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.living_fractal.gl', _gl)
...
@patch('vjlive3.plugins.living_fractal.gl', _gl)
@patch('vjlive3.plugins.living_fractal.hasattr')
