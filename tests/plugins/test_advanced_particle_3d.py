"""Tests for P6-P302: AdvancedParticle3DPlugin."""
import pytest
...
from vjlive3.plugins.advanced_particle_3d import AdvancedParticle3DPlugin, METADATA
...
def plugin():
    ...
    _mock_gl.glCreateProgram.return_value = 99; _mock_gl.glGenVertexArrays.return_value = 44
    _mock_gl.glGenTextures.return_value = 55; _mock_gl.glGenFramebuffers.return_value = 51
    return AdvancedParticle3DPlugin()
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Advanced Particle 3D'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.advanced_particle_3d.gl', _mock_gl)
...
@patch('vjlive3.plugins.advanced_particle_3d.gl', _mock_gl)
@patch('vjlive3.plugins.advanced_particle_3d.hasattr')
