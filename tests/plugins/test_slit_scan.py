"""Tests for P7-VE65: SlitScanPlugin."""
import pytest
...
from vjlive3.plugins.slit_scan import SlitScanPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Slit Scan'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.slit_scan.gl', _gl)
...
@patch('vjlive3.plugins.slit_scan.gl', _gl)
@patch('vjlive3.plugins.slit_scan.hasattr')
