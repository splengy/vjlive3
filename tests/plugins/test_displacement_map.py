"""Tests for P7-VE31: DisplacementMapPlugin."""
import pytest
...
from vjlive3.plugins.displacement_map import DisplacementMapPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Displacement Map'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.displacement_map.gl', _gl)
...
@patch('vjlive3.plugins.displacement_map.gl', _gl)
@patch('vjlive3.plugins.displacement_map.hasattr')
