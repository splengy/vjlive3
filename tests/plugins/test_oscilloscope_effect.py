"""Tests for P7-VE51: OscilloscopePlugin."""
import pytest
...
from vjlive3.plugins.oscilloscope_effect import OscilloscopePlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Oscilloscope Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.oscilloscope_effect.gl', _gl)
...
@patch('vjlive3.plugins.oscilloscope_effect.gl', _gl)
@patch('vjlive3.plugins.oscilloscope_effect.hasattr')
