"""Tests for P7-VE41: ScrollPlugin."""
import pytest
...
from vjlive3.plugins.scroll_effect import ScrollPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Scroll Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.scroll_effect.gl', _gl)
...
@patch('vjlive3.plugins.scroll_effect.gl', _gl)
@patch('vjlive3.plugins.scroll_effect.hasattr')
