"""Tests for P7-VE07: BassCanon2Plugin."""
import pytest
...
from vjlive3.plugins.bass_cannon_2 import BassCanon2Plugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Bass Cannon 2'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.bass_cannon_2.gl', _gl)
...
@patch('vjlive3.plugins.bass_cannon_2.gl', _gl)
@patch('vjlive3.plugins.bass_cannon_2.hasattr')
