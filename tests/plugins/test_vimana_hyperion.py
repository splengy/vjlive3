"""Tests for P7-VE44: VimanaHyperionPlugin."""
import pytest
...
from vjlive3.plugins.vimana_hyperion import VimanaHyperionPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Vimana Hyperion'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.vimana_hyperion.gl', _gl)
...
@patch('vjlive3.plugins.vimana_hyperion.gl', _gl)
@patch('vjlive3.plugins.vimana_hyperion.hasattr')
