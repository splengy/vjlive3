"""Tests for P7-VE47: LumaChromaMaskPlugin."""
import pytest
...
from vjlive3.plugins.luma_chroma_mask import LumaChromaMaskPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Luma Chroma Mask'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.luma_chroma_mask.gl', _gl)
...
@patch('vjlive3.plugins.luma_chroma_mask.gl', _gl)
@patch('vjlive3.plugins.luma_chroma_mask.hasattr')
