"""Tests for P7-VE11: BlendDiffPlugin."""
import pytest
...
from vjlive3.plugins.blend_diff import BlendDiffPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Blend Diff'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.blend_diff.gl', _gl)
...
@patch('vjlive3.plugins.blend_diff.gl', _gl)
@patch('vjlive3.plugins.blend_diff.hasattr')
