"""Tests for P7-VE30: ColoramaPlugin."""
import pytest
...
from vjlive3.plugins.colorama import ColoramaPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Colorama'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.colorama.gl', _gl)
...
@patch('vjlive3.plugins.colorama.gl', _gl)
@patch('vjlive3.plugins.colorama.hasattr')
