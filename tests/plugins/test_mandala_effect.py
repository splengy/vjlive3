"""Tests for P6-GE11: MandalaPlugin."""
import pytest
...
from vjlive3.plugins.mandala_effect import MandalaPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Mandala Effect'
    assert len(m["parameters"]) == 12

@patch('vjlive3.plugins.mandala_effect.gl', _mock_gl)
...
@patch('vjlive3.plugins.mandala_effect.gl', _mock_gl)
@patch('vjlive3.plugins.mandala_effect.hasattr')
