"""Tests for P7-VE27: RGBShiftPlugin."""
import pytest
...
from vjlive3.plugins.rgb_shift import RGBShiftPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Rgb Shift'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.rgb_shift.gl', _gl)
...
@patch('vjlive3.plugins.rgb_shift.gl', _gl)
@patch('vjlive3.plugins.rgb_shift.hasattr')
