"""Tests for P6-QC11: NeuralRaveNexusPlugin."""
import pytest
...
from vjlive3.plugins.neural_rave_nexus import NeuralRaveNexusPlugin, METADATA
...
def test_metadata(plugin):
    ...
    assert m["name"] == 'Neural Rave Nexus'
    assert len(m["parameters"]) == 8

@patch('vjlive3.plugins.neural_rave_nexus.gl', _mock_gl)
...
@patch('vjlive3.plugins.neural_rave_nexus.gl', _mock_gl)
@patch('vjlive3.plugins.neural_rave_nexus.hasattr')
