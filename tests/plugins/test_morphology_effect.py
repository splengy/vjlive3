"""Tests for P7-VE50: MorphologyPlugin."""
import pytest
...
from vjlive3.plugins.morphology_effect import MorphologyPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Morphology Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.morphology_effect.gl', _gl)
...
@patch('vjlive3.plugins.morphology_effect.gl', _gl)
@patch('vjlive3.plugins.morphology_effect.hasattr')
