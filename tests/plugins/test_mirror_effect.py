"""Tests for P7-VE42: MirrorPlugin."""
import pytest
...
from vjlive3.plugins.mirror_effect import MirrorPlugin, METADATA
...
def test_metadata(plugin):
    m=plugin.get_metadata(); assert m["name"]=='Mirror Effect'; assert len(m["parameters"])==6
@patch('vjlive3.plugins.mirror_effect.gl', _gl)
...
@patch('vjlive3.plugins.mirror_effect.gl', _gl)
@patch('vjlive3.plugins.mirror_effect.hasattr')
