"""
P7-VE61: Image in — static image loader and compositor.
...
METADATA = {
    "name": "Image In",
    "description": "Image in — static image loader and compositor.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['image', 'loader', 'composite', 'static', 'overlay'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'pos_x', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'pos_y', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'opacity', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}, {'name': 'blend_mode', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float scale;  // Image scale
uniform float pos_x;  // Position X
uniform float pos_y;  // Position Y
...
_PARAM_NAMES = ['scale', 'pos_x', 'pos_y', 'opacity', 'blend_mode', 'mix']
_PARAM_DEFAULTS = {'scale': 5.0, 'pos_x': 5.0, 'pos_y': 5.0, 'opacity': 8.0, 'blend_mode': 0.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class ImageInPlugin(EffectPlugin):
    """Image in — static image loader and compositor."""
    def __init__(self):
        super().__init__()
