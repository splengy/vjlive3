"""
P6-GE15: Harmonic patterns — Lissajous curves and harmonic series visualization.
...
METADATA = {
    ...
    "description": "Harmonic patterns — Lissajous curves and harmonic series visualization.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['harmonic', 'lissajous', 'math', 'generative', 'geometric'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'freq_x', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'freq_y', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'phase', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'damping', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'pattern_count', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'line_width', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation_speed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'modulation', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'bass_response', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float freq_x;  // X frequency
uniform float freq_y;  // Y frequency
uniform float phase;  // Phase offset
uniform float damping;  // Damping
uniform float pattern_count;  // Overlay count
...
uniform float modulation;  // Frequency modulation
...
void main() {
    ...
    float disp     = (freq_x / 10.0);
    float feed     = (feedback / 10.0);
    float freq_v   = 8.0 + (rotation_speed / 10.0) * 10.0;
    float chroma   = 0.0;
    float vign_v   = 0.0;
...
_PARAM_NAMES = ['freq_x', 'freq_y', 'phase', 'damping', 'pattern_count', 'color_hue', 'line_width', 'rotation_speed', 'feedback', 'glow', 'modulation', 'bass_response']
_PARAM_DEFAULTS = {'freq_x': 5.0, 'freq_y': 5.0, 'phase': 5.0, 'damping': 3.0, 'pattern_count': 5.0, 'color_hue': 5.0, 'line_width': 3.0, 'rotation_speed': 3.0, 'feedback': 0.0, 'glow': 3.0, 'modulation': 3.0, 'bass_response': 5.0}
...
class HarmonicPatternsPlugin(EffectPlugin):
