"""
P6-GE11: Mandala generator — rotationally symmetric geometric patterns.
...
METADATA = {
    "name": "Mandala Effect",
    "description": "Mandala generator — rotationally symmetric geometric patterns.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['mandala', 'symmetry', 'sacred', 'geometric', 'generative'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'petals', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rings', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation_speed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'inner_radius', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'detail', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_range', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'pulse', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'invert', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float petals;  // Number of petals
uniform float rings;  // Ring count
uniform float rotation_speed;  // Rotation speed
uniform float inner_radius;  // Inner radius
uniform float detail;  // Detail level
uniform float color_hue;  // Base hue
uniform float color_range;  // Hue range
uniform float glow;  // Glow amount
uniform float pulse;  // Pulse rate
uniform float warp;  // Warp amount
uniform float invert;  // Invert
...
_PARAM_NAMES = ['petals', 'rings', 'rotation_speed', 'inner_radius', 'detail', 'color_hue', 'color_range', 'glow', 'pulse', 'warp', 'invert', 'feedback']
_PARAM_DEFAULTS = {'petals': 5.0, 'rings': 5.0, 'rotation_speed': 3.0, 'inner_radius': 3.0, 'detail': 7.0, 'color_hue': 5.0, 'color_range': 5.0, 'glow': 3.0, 'pulse': 3.0, 'warp': 0.0, 'invert': 0.0, 'feedback': 0.0}
...
class MandalaPlugin(EffectPlugin):
