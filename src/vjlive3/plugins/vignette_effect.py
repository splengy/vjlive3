"""
P7-VE13: Vignette — smooth dark vignette border.
...
METADATA = {
    ...
    "description": "Vignette — smooth dark vignette border.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['vignette', 'border', 'cinematic', 'dark', 'frame'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'radius', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'softness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'intensity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'roundness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float intensity;  // Darkness
uniform float roundness;  // Oval vs circular
uniform float color_hue;  // Tint color
...
_PARAM_NAMES = ['radius', 'softness', 'intensity', 'roundness', 'color_hue', 'mix']
_PARAM_DEFAULTS = {'radius': 7.0, 'softness': 5.0, 'intensity': 5.0, 'roundness': 5.0, 'color_hue': 0.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class VignettePlugin(EffectPlugin):
    """Vignette — smooth dark vignette border."""
    def __init__(self):
        super().__init__()
