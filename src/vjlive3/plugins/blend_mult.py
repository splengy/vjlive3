"""
P7-VE10: Multiplicative blend — multiplies two video inputs.
...
METADATA = {
    "name": "Blend Mult",
    "description": "Multiplicative blend — multiplies two video inputs.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['blend', 'multiply', 'composite', 'mix', 'multiply'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'amount', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}, {'name': 'gamma', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'brightness_a', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'brightness_b', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'exposure', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
_PARAM_NAMES = ['amount', 'gamma', 'brightness_a', 'brightness_b', 'exposure', 'mix']
_PARAM_DEFAULTS = {'amount': 8.0, 'gamma': 5.0, 'brightness_a': 5.0, 'brightness_b': 5.0, 'exposure': 5.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class BlendMultPlugin(EffectPlugin):
    """Multiplicative blend — multiplies two video inputs."""
    def __init__(self):
        super().__init__()
