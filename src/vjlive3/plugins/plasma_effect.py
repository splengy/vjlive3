"""
P6-GE12: Plasma generator — classic interference plasma patterns.
...
METADATA = {
    "name": "Plasma Effect",
    "description": "Plasma generator — classic interference plasma patterns.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['plasma', 'interference', 'psychedelic', 'generative', 'colorful'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'complexity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'saturation', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}, {'name': 'brightness', 'type': 'float', 'default': 6.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'contrast', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix_input', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float scale;  // Pattern scale
uniform float complexity;  // Wave count
uniform float color_speed;  // Color cycle
uniform float palette_hue;  // Base hue
uniform float saturation;  // Saturation
uniform float brightness;  // Brightness
uniform float warp;  // Self-warp
uniform float feedback;  // Feedback
uniform float contrast;  // Contrast
uniform float mix_input;  // Mix with video input
...
_PARAM_NAMES = ['speed', 'scale', 'complexity', 'color_speed', 'palette_hue', 'saturation', 'brightness', 'warp', 'feedback', 'contrast', 'mix_input']
_PARAM_DEFAULTS = {'speed': 5.0, 'scale': 5.0, 'complexity': 5.0, 'color_speed': 5.0, 'palette_hue': 5.0, 'saturation': 8.0, 'brightness': 6.0, 'warp': 3.0, 'feedback': 0.0, 'contrast': 5.0, 'mix_input': 0.0}
...
class PlasmaPlugin(EffectPlugin):
