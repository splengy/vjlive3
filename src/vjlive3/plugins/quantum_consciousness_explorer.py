"""
P6-QC12: Quantum consciousness explorer — multi-dimensional consciousness visualization.
...
METADATA = {
    ...
    "description": "Quantum consciousness explorer — multi-dimensional consciousness visualization.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['quantum', 'consciousness', 'dimensional', 'psychedelic', 'meditation'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'quantum_depth', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'consciousness_level', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'dimensional_fold', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'resonance', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'entanglement', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'decoherence', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'observer_effect', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'singularity_pull', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float quantum_depth;  // Quantum depth
uniform float consciousness_level;  // Consciousness
uniform float dimensional_fold;  // Dimensional fold
uniform float resonance;  // Resonance
uniform float entanglement;  // Entanglement
uniform float decoherence;  // Decoherence
uniform float observer_effect;  // Observer effect
uniform float singularity_pull;  // Singularity
...
void main() {
    ...
    color.r *= 1.0 + 0.0;
    color.g *= 1.0 + 0.0;
    color.b *= 1.0 + quantum_depth/10.0*0.3;
    color = clamp(color, 0.0, 1.0);
    fragColor = mix(curr, vec4(color, curr.a), u_mix);
}
"""

_PARAM_NAMES = ['quantum_depth', 'consciousness_level', 'dimensional_fold', 'resonance', 'entanglement', 'decoherence', 'observer_effect', 'singularity_pull']
_PARAM_DEFAULTS = {'quantum_depth': 5.0, 'consciousness_level': 5.0, 'dimensional_fold': 5.0, 'resonance': 5.0, 'entanglement': 5.0, 'decoherence': 3.0, 'observer_effect': 5.0, 'singularity_pull': 3.0}
...
class QuantumConsciousnessExplorerPlugin(EffectPlugin):
