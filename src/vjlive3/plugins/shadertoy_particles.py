"""
P6-P304: Shadertoy-style GPU particles — complex shader particle field.
...
METADATA = {
    "name": "Shadertoy Particles",
    "description": "Shadertoy-style GPU particles — complex shader particle field.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "particles",
    "tags": ['particles', 'shadertoy', 'gpu', 'field', 'generative'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'brightness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_saturation', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'particle_size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'trail_length', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'volume_level', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'bass_level', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'chaos', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'field_scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'emit_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'gravity', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float color_saturation;  // Saturation
uniform float particle_size;  // Size
uniform float trail_length;  // Trail
uniform float volume_level;  // Audio volume
uniform float bass_level;  // Bass level
uniform float speed;  // Animation speed
uniform float chaos;  // Chaos
uniform float field_scale;  // Field scale
uniform float emit_rate;  // Emit rate
...
_PARAM_NAMES = ['brightness', 'color_hue', 'color_saturation', 'particle_size', 'trail_length', 'volume_level', 'bass_level', 'speed', 'chaos', 'field_scale', 'emit_rate', 'gravity']
_PARAM_DEFAULTS = {'brightness': 5.0, 'color_hue': 5.0, 'color_saturation': 5.0, 'particle_size': 5.0, 'trail_length': 5.0, 'volume_level': 5.0, 'bass_level': 5.0, 'speed': 5.0, 'chaos': 3.0, 'field_scale': 5.0, 'emit_rate': 5.0, 'gravity': 3.0}
...
class ShadertoyParticlesPlugin(EffectPlugin):
