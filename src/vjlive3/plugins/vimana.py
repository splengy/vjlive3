"""
P7-VE77: Vimana — sacred geometric craft visualization.
...
METADATA = {
    "name": "Vimana",
    "description": "Vimana — sacred geometric craft visualization.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['vimana', 'sacred', 'geometric', 'mystical', 'ancient'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'rotation_speed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow_radius', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'geometry_type', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float glow_radius;  // Glow
...
_PARAM_NAMES = ['rotation_speed', 'scale', 'color_hue', 'glow_radius', 'geometry_type', 'mix']
_PARAM_DEFAULTS = {'rotation_speed': 3.0, 'scale': 5.0, 'color_hue': 5.0, 'glow_radius': 3.0, 'geometry_type': 5.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class VimanaPlugin(EffectPlugin):
    """Vimana — sacred geometric craft visualization."""
    def __init__(self):
        super().__init__()
