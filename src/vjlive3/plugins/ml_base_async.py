"""
P6-QC08: ML async base — backbone for async ML-driven video effects.
...
METADATA = {
    "name": "Ml Base Async",
    "description": "ML async base — backbone for async ML-driven video effects.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['ml', 'async', 'neural', 'gpu', 'inference'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'inference_strength', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'blend_mode', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'feature_scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'time_scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_correction', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'sharpness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'noise_reduction', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'output_mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float inference_strength;  // ML strength
uniform float blend_mode;  // Blend mode
uniform float feature_scale;  // Feature scale
uniform float time_scale;  // Temporal scale
uniform float color_correction;  // Color correct
uniform float sharpness;  // Sharpness
uniform float noise_reduction;  // Denoise
uniform float output_mix;  // Output mix
...
_PARAM_NAMES = ['inference_strength', 'blend_mode', 'feature_scale', 'time_scale', 'color_correction', 'sharpness', 'noise_reduction', 'output_mix']
_PARAM_DEFAULTS = {'inference_strength': 5.0, 'blend_mode': 5.0, 'feature_scale': 5.0, 'time_scale': 5.0, 'color_correction': 5.0, 'sharpness': 5.0, 'noise_reduction': 5.0, 'output_mix': 8.0}
...
class MLBaseAsyncPlugin(EffectPlugin):
