"""
P7-VE02: Horizontal wave — sine UV warp along X axis.
...
METADATA = {
    ...
    "description": "Horizontal wave — sine UV warp along X axis.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['wave', 'horizontal', 'distortion', 'uv', 'warp'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
...
class HorizontalWavePlugin(EffectPlugin):
    """Horizontal wave — sine UV warp along X axis."""
    def __init__(self):
        super().__init__()
