"""
P6-GE13: Perlin flow field — vector field visualization from Perlin gradient noise.
...
METADATA = {
    "name": "Perlin Effect",
    "description": "Perlin flow field — vector field visualization from Perlin gradient noise.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['perlin', 'flow-field', 'vector', 'generative', 'fluid'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'field_scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'flow_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'particle_count', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'trail_length', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_mode', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'line_width', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'turbulence', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'curl', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'fade_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
void main() {
    ...
    float freq_v   = 8.0 + (flow_speed / 10.0) * 10.0;
    float chroma   = 0.0;
    float vign_v   = 0.0;
...
_PARAM_NAMES = ['field_scale', 'flow_speed', 'particle_count', 'trail_length', 'color_mode', 'line_width', 'turbulence', 'curl', 'fade_rate', 'palette_hue', 'feedback']
_PARAM_DEFAULTS = {'field_scale': 5.0, 'flow_speed': 5.0, 'particle_count': 5.0, 'trail_length': 5.0, 'color_mode': 5.0, 'line_width': 3.0, 'turbulence': 5.0, 'curl': 5.0, 'fade_rate': 5.0, 'palette_hue': 5.0, 'feedback': 5.0}
...
class PerlinPlugin(EffectPlugin):
