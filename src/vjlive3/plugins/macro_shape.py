"""
P6-GE17: Macro shape generator — super-ellipse, rose curve, polygon patterns.
...
METADATA = {
    "name": "Macro Shape",
    "description": "Macro shape generator — super-ellipse, rose curve, polygon patterns.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['shape', 'polygon', 'geometric', 'generative', 'super-ellipse'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'shape_type', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'sides', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation_speed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'inner_size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'pulse', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'fill_type', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float shape_type;  // 0=circle,3=polygon,5=rose,7=superellipse,10=star
uniform float sides;  // Polygon sides
uniform float size;  // Shape size
uniform float rotation_speed;  // Rotation speed
uniform float inner_size;  // Inner size
uniform float color_hue;  // Base hue
uniform float glow;  // Glow
uniform float pulse;  // Pulse
uniform float feedback;  // Feedback
uniform float fill_type;  // 0=outline,5=gradient,10=solid
uniform float warp;  // Warp
...
_PARAM_NAMES = ['shape_type', 'sides', 'size', 'rotation_speed', 'inner_size', 'color_hue', 'glow', 'pulse', 'feedback', 'fill_type', 'warp']
_PARAM_DEFAULTS = {'shape_type': 0.0, 'sides': 5.0, 'size': 5.0, 'rotation_speed': 3.0, 'inner_size': 5.0, 'color_hue': 5.0, 'glow': 3.0, 'pulse': 3.0, 'feedback': 0.0, 'fill_type': 0.0, 'warp': 0.0}
...
class MacroShapePlugin(EffectPlugin):
