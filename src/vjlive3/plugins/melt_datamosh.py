"""
P5-DM13: Melt datamosh — pixels drip and slide downward in viscous waves.
Ported from VJlive-2/plugins/vdatamosh/melt_datamosh.py.
"""
...
METADATA = {
    "name": "Melt Datamosh",
    "description": "Melt datamosh — pixels drip and slide downward in viscous waves.",
    "version": "1.0.0",
    "plugin_type": "datamosh",
    "category": "datamosh",
    "tags": ['melt', 'drip', 'gravity', 'datamosh', 'liquid'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'melt_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'viscosity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'heat', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'drip_length', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'turbulence', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_bleed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'depth_melt', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'surface_tension', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'gravity', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'crystallize', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'entropy', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float heat;  // Heat distortion
uniform float drip_length;  // Drip distance
uniform float turbulence;  // Flow chaos
uniform float color_bleed;  // Color bleeding
uniform float depth_melt;  // Depth-driven melt
uniform float surface_tension;  // Surface tension
uniform float gravity;  // Gravity strength
...
_PARAM_NAMES = ['melt_speed', 'viscosity', 'heat', 'drip_length', 'turbulence', 'color_bleed', 'depth_melt', 'surface_tension', 'gravity', 'feedback', 'crystallize', 'entropy']
_PARAM_DEFAULTS = {'melt_speed': 5.0, 'viscosity': 5.0, 'heat': 5.0, 'drip_length': 5.0, 'turbulence': 3.0, 'color_bleed': 3.0, 'depth_melt': 5.0, 'surface_tension': 5.0, 'gravity': 7.0, 'feedback': 5.0, 'crystallize': 0.0, 'entropy': 5.0}
...
class MeltDatamoshPlugin(EffectPlugin):
