"""
P7-VE01: V-Sws sine wave scan — horizontal+vertical combined sine scan.
...
METADATA = {
    "name": "V Sws",
    "description": "V-Sws sine wave scan — horizontal+vertical combined sine scan.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['wave', 'scan', 'sws', 'distortion', 'psychedelic'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'amplitude', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'frequency', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'phase', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_shift', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float frequency;  // Wave freq
...
_PARAM_NAMES = ['amplitude', 'frequency', 'speed', 'phase', 'color_shift', 'mix']
_PARAM_DEFAULTS = {'amplitude': 5.0, 'frequency': 5.0, 'speed': 5.0, 'phase': 0.0, 'color_shift': 0.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class VSwsPlugin(EffectPlugin):
    """V-Sws sine wave scan — horizontal+vertical combined sine scan."""
    def __init__(self):
        super().__init__()
