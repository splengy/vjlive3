"""
P6-GE16: FM coordinates — frequency-modulated coordinate transformations.
...
METADATA = {
    "name": "Fm Coordinates",
    "description": "FM coordinates — frequency-modulated coordinate transformations.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['fm', 'frequency-modulation', 'coordinates', 'generative', 'math'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'carrier_freq', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'modulator_freq', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'mod_depth', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'phase_offset', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_from_phase', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'symmetry', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'brightness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'anti_alias', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'bass_mod', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float modulator_freq;  // Mod frequency
uniform float mod_depth;  // Modulation depth
uniform float phase_offset;  // Phase offset
uniform float feedback;  // Coordinate feedback
uniform float color_from_phase;  // Color from phase
uniform float symmetry;  // Symmetry order
uniform float scale;  // Output scale
uniform float rotation;  // Rotation
uniform float brightness;  // Brightness
uniform float anti_alias;  // Anti-aliasing
uniform float bass_mod;  // Bass modulation
...
void main() {
    ...
    color.r *= 1.0 + 0.0;
    color.g *= 1.0 + brightness/10.0*0.2;
...
_PARAM_NAMES = ['carrier_freq', 'modulator_freq', 'mod_depth', 'phase_offset', 'feedback', 'color_from_phase', 'symmetry', 'scale', 'rotation', 'brightness', 'anti_alias', 'bass_mod']
_PARAM_DEFAULTS = {'carrier_freq': 5.0, 'modulator_freq': 5.0, 'mod_depth': 5.0, 'phase_offset': 0.0, 'feedback': 3.0, 'color_from_phase': 5.0, 'symmetry': 5.0, 'scale': 5.0, 'rotation': 0.0, 'brightness': 5.0, 'anti_alias': 7.0, 'bass_mod': 5.0}
...
class FMCoordinatesPlugin(EffectPlugin):
