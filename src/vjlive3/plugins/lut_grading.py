"""
P7-VE48: LUT grading — 1D look-up table colour grade.
...
METADATA = {
    "name": "Lut Grading",
    "description": "LUT grading — 1D look-up table colour grade.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['lut', 'grade', 'color', 'cinematic', 'film'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'lut_intensity', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}, {'name': 'saturation', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'contrast', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'temperature', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'tint', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
_PARAM_NAMES = ['lut_intensity', 'saturation', 'contrast', 'temperature', 'tint', 'mix']
_PARAM_DEFAULTS = {'lut_intensity': 8.0, 'saturation': 5.0, 'contrast': 5.0, 'temperature': 5.0, 'tint': 5.0, 'mix': 8.0}
