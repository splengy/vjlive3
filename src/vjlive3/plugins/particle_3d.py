"""
P6-P303: 3D particle system — depth-aware particle simulation.
...
METADATA = {
    "name": "Particle 3D",
    "description": "3D particle system — depth-aware particle simulation.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "particles",
    "tags": ['particles', '3d', 'depth', 'simulation', 'interactive'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'particle_count', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'particle_size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'emission_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'lifetime', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'gravity', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'depth_attraction', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'audio_bass', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'audio_treble', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_mode', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'trail_length', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'spread', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'twist', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float particle_count;  // Particle count
uniform float particle_size;  // Size
uniform float emission_rate;  // Emit rate
uniform float lifetime;  // Lifetime
uniform float gravity;  // Gravity
uniform float depth_attraction;  // Depth pull
uniform float audio_bass;  // Bass force
uniform float audio_treble;  // Treble sparkle
uniform float color_mode;  // Color mode
uniform float trail_length;  // Trail
uniform float spread;  // Spread cone
uniform float twist;  // Twist force
...
_PARAM_NAMES = ['particle_count', 'particle_size', 'emission_rate', 'lifetime', 'gravity', 'depth_attraction', 'audio_bass', 'audio_treble', 'color_mode', 'trail_length', 'spread', 'twist']
_PARAM_DEFAULTS = {'particle_count': 7.0, 'particle_size': 5.0, 'emission_rate': 5.0, 'lifetime': 5.0, 'gravity': 3.0, 'depth_attraction': 5.0, 'audio_bass': 5.0, 'audio_treble': 5.0, 'color_mode': 5.0, 'trail_length': 3.0, 'spread': 5.0, 'twist': 0.0}
...
class Particle3DPlugin(EffectPlugin):
