"""
P7-VE05: Spiral wave — rotating spiral UV distortion.
...
METADATA = {
    "name": "Spiral Wave",
    "description": "Spiral wave — rotating spiral UV distortion.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['spiral', 'wave', 'rotation', 'distortion', 'swirl'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'amplitude', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'frequency', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'tightness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'phase', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float frequency;  // Spiral turns
uniform float speed;  // Rotation speed
uniform float tightness;  // Spiral tightness
...
_PARAM_NAMES = ['amplitude', 'frequency', 'speed', 'tightness', 'phase', 'mix']
_PARAM_DEFAULTS = {'amplitude': 5.0, 'frequency': 5.0, 'speed': 5.0, 'tightness': 5.0, 'phase': 0.0, 'mix': 8.0}

def _map(val,lo,hi): return lo+(max(0.,min(10.,float(val)))/10.)*(hi-lo)

class SpiralWavePlugin(EffectPlugin):
    """Spiral wave — rotating spiral UV distortion."""
    def __init__(self):
        super().__init__()
