"""
P6-QC06: Traveling avatar — animated agent avatar traversing the depth field.
...
METADATA = {
    "name": "Traveling Avatar",
    "description": "Traveling avatar — animated agent avatar traversing the depth field.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['avatar', 'agent', 'depth', 'animation', 'ai'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'travel_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'avatar_size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'trail_length', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow_strength', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'depth_follow', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'pulse_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'opacity', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float travel_speed;  // Avatar speed
uniform float avatar_size;  // Size
uniform float trail_length;  // Trail
uniform float glow_strength;  // Glow
uniform float depth_follow;  // Depth following
uniform float color_hue;  // Hue
uniform float pulse_rate;  // Pulse
...
void main() {
    ...
    color.r *= 1.0 + glow_strength/10.0*0.3;
...
_PARAM_NAMES = ['travel_speed', 'avatar_size', 'trail_length', 'glow_strength', 'depth_follow', 'color_hue', 'pulse_rate', 'opacity']
_PARAM_DEFAULTS = {'travel_speed': 5.0, 'avatar_size': 5.0, 'trail_length': 5.0, 'glow_strength': 5.0, 'depth_follow': 5.0, 'color_hue': 5.0, 'pulse_rate': 5.0, 'opacity': 8.0}
...
class TravelingAvatarPlugin(EffectPlugin):
