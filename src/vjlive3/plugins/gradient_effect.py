"""
P6-GE10: Gradient generator — animated multi-stop gradients with noise warp.
...
METADATA = {
    ...
    "description": "Gradient generator — animated multi-stop gradients with noise warp.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['gradient', 'color', 'smooth', 'generative', 'ambient'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'color_stops', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp_amount', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'saturation', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'brightness', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'hue_start', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'hue_range', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'radial_mix', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'vignette', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'pulse_speed', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'contrast', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float color_stops;  // Stop count
uniform float speed;  // Cycle speed
uniform float rotation;  // Gradient angle
uniform float warp_amount;  // Noise warp
uniform float saturation;  // Saturation
uniform float brightness;  // Brightness
uniform float hue_start;  // Start hue
uniform float hue_range;  // Hue range
uniform float radial_mix;  // Radial blend
...
_PARAM_NAMES = ['color_stops', 'speed', 'rotation', 'warp_amount', 'saturation', 'brightness', 'hue_start', 'hue_range', 'radial_mix', 'vignette', 'pulse_speed', 'contrast']
_PARAM_DEFAULTS = {'color_stops': 5.0, 'speed': 5.0, 'rotation': 0.0, 'warp_amount': 3.0, 'saturation': 7.0, 'brightness': 5.0, 'hue_start': 0.0, 'hue_range': 5.0, 'radial_mix': 0.0, 'vignette': 0.0, 'pulse_speed': 3.0, 'contrast': 5.0}
