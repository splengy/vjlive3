"""
P6-GE19: Resonant geometry — geometry that resonates with audio frequencies.
...
METADATA = {
    "name": "Resonant Geometry",
    "description": "Resonant geometry — geometry that resonates with audio frequencies.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['geometry', 'resonance', 'audio', 'generative', 'sacred'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'resonant_freq', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'geometry_type', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'amplitude', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'decay_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'harmonic_order', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'bass_response', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'treble_response', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'node_count', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float resonant_freq;  // Resonant frequency
uniform float geometry_type;  // Geometry preset
uniform float amplitude;  // Vibration amplitude
uniform float decay_rate;  // Decay
uniform float harmonic_order;  // Harmonic order
uniform float color_hue;  // Base hue
uniform float glow;  // Glow
uniform float rotation;  // Rotation
uniform float feedback;  // Feedback
uniform float bass_response;  // Bass response
uniform float treble_response;  // Treble response
uniform float node_count;  // Resonant nodes
...
void main() {
    ...
    color.r *= 1.0 + color_hue/10.0*0.3;
    color.g *= 1.0 + glow/10.0*0.2;
...
_PARAM_NAMES = ['resonant_freq', 'geometry_type', 'amplitude', 'decay_rate', 'harmonic_order', 'color_hue', 'glow', 'rotation', 'feedback', 'bass_response', 'treble_response', 'node_count']
_PARAM_DEFAULTS = {'resonant_freq': 5.0, 'geometry_type': 5.0, 'amplitude': 5.0, 'decay_rate': 5.0, 'harmonic_order': 5.0, 'color_hue': 5.0, 'glow': 3.0, 'rotation': 0.0, 'feedback': 3.0, 'bass_response': 5.0, 'treble_response': 5.0, 'node_count': 5.0}
...
class ResonantGeometryPlugin(EffectPlugin):
