"""
P6-GE08: Noise generator — fractal Perlin/simplex noise with warp, fire, ocean.
...
METADATA = {
    "name": "Noise Effect",
    "description": "Noise generator — fractal Perlin/simplex noise with warp, fire, ocean.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['noise', 'perlin', 'fractal', 'generative', 'terrain'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'octaves', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'persistence', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'lacunarity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_mode', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'contrast', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'edge_detect', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_range', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float scale;  // 0.5-50 scale
uniform float speed;  // Time multiplier
uniform float octaves;  // Fractal layers
uniform float persistence;  // Amplitude decay
uniform float lacunarity;  // Freq multiplier
uniform float warp;  // Domain warp
uniform float color_mode;  // 0=mono,3=gradient,5=psychedelic,7=fire,10=ocean
uniform float contrast;  // Output contrast
uniform float edge_detect;  // Edge ridges
...
_PARAM_NAMES = ['scale', 'speed', 'octaves', 'persistence', 'lacunarity', 'warp', 'color_mode', 'contrast', 'edge_detect', 'palette_hue', 'palette_range']
_PARAM_DEFAULTS = {'scale': 5.0, 'speed': 5.0, 'octaves': 5.0, 'persistence': 5.0, 'lacunarity': 5.0, 'warp': 3.0, 'color_mode': 0.0, 'contrast': 5.0, 'edge_detect': 0.0, 'palette_hue': 5.0, 'palette_range': 5.0}
...
class NoisePlugin(EffectPlugin):
