"""
P6-GE06: Fractal generator — Mandelbrot, Julia, Burning Ship and more.
...
METADATA = {
    ...
    "description": "Fractal generator — Mandelbrot, Julia, Burning Ship and more.",
    "version": "1.0.0",
    "plugin_type": "generator",
    "category": "generator",
    "tags": ['fractal', 'mandelbrot', 'julia', 'generative', 'mathematical'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'fractal_type', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'zoom', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'center_x', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'center_y', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'iterations', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_mode', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_hue', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'palette_range', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'julia_cx', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'julia_cy', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'rotation', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'escape_power', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float fractal_type;  // Fractal type (0=Mandelbrot,5=Julia,10=BurningShip)
uniform float zoom;  // Zoom factor
uniform float center_x;  // Center X
uniform float center_y;  // Center Y
uniform float iterations;  // Max iterations
uniform float color_mode;  // Coloring mode
uniform float palette_hue;  // Base hue
uniform float palette_range;  // Hue spread
uniform float julia_cx;  // Julia C real
uniform float julia_cy;  // Julia C imaginary
uniform float rotation;  // Rotation
uniform float escape_power;  // Escape radius power
...
_PARAM_NAMES = ['fractal_type', 'zoom', 'center_x', 'center_y', 'iterations', 'color_mode', 'palette_hue', 'palette_range', 'julia_cx', 'julia_cy', 'rotation', 'escape_power']
_PARAM_DEFAULTS = {'fractal_type': 0.0, 'zoom': 5.0, 'center_x': 5.0, 'center_y': 5.0, 'iterations': 5.0, 'color_mode': 5.0, 'palette_hue': 5.0, 'palette_range': 5.0, 'julia_cx': 5.0, 'julia_cy': 5.0, 'rotation': 0.0, 'escape_power': 5.0}
...
class FractalGeneratorPlugin(EffectPlugin):
