"""
P5-DM16: Datamosh 3D — depth-driven layer separation and 3D displacement.
Ported from VJlive-2/plugins/vdatamosh/datamosh_3d.py.
"""
...
METADATA = {
    "name": "Datamosh 3D",
    "description": "Datamosh 3D — depth-driven layer separation and 3D displacement.",
    "version": "1.0.0",
    "plugin_type": "datamosh",
    "category": "datamosh",
    "tags": ['3d', 'depth', 'datamosh', 'parallax', 'layered'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
...
uniform float time;
uniform float u_mix;
uniform float intensity;  // Overall strength
uniform float scale;  // Scale
uniform float speed;  // Animation speed
uniform float threshold;  // Depth threshold
uniform float foreground_mix;  // FG blend
uniform float background_mix;  // BG blend
...
class Datamosh3DPlugin(EffectPlugin):
