"""
P5-DM27: Plasma melt — hot plasma fluid simulation with color diffusion.
Ported from VJlive-2/plugins/vdatamosh/plasma_melt_datamosh.py.
"""
...
METADATA = {
    "name": "Plasma Melt Datamosh",
    "description": "Plasma melt — hot plasma fluid simulation with color diffusion.",
    "version": "1.0.0",
    "plugin_type": "datamosh",
    "category": "datamosh",
    "tags": ['plasma', 'melt', 'heat', 'datamosh', 'fluid'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'viscosity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'temperature', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'turbulence', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'plasma_scale', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'melt_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'surface_tension', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_diffusion', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'depth_viscosity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'bubble_rate', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'flow_direction', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'crystallize', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}, {'name': 'entropy', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float viscosity;  // Plasma viscosity
uniform float temperature;  // Heat level
uniform float turbulence;  // Flow chaos
uniform float plasma_scale;  // Scale
uniform float melt_speed;  // Melt rate
uniform float surface_tension;  // Surface tension
uniform float color_diffusion;  // Color spread
uniform float depth_viscosity;  // Depth-driven viscosity
uniform float bubble_rate;  // Bubble rate
uniform float flow_direction;  // Flow direction
uniform float crystallize;  // Crystallize
uniform float entropy;  // Entropy
...
_PARAM_NAMES = ['viscosity', 'temperature', 'turbulence', 'plasma_scale', 'melt_speed', 'surface_tension', 'color_diffusion', 'depth_viscosity', 'bubble_rate', 'flow_direction', 'crystallize', 'entropy']
_PARAM_DEFAULTS = {'viscosity': 5.0, 'temperature': 5.0, 'turbulence': 5.0, 'plasma_scale': 5.0, 'melt_speed': 5.0, 'surface_tension': 5.0, 'color_diffusion': 5.0, 'depth_viscosity': 5.0, 'bubble_rate': 3.0, 'flow_direction': 5.0, 'crystallize': 0.0, 'entropy': 5.0}
...
class PlasmaMeltDatamoshPlugin(EffectPlugin):
