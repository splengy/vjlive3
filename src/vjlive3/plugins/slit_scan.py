"""
P7-VE65: Slit scan — temporal slit-scan photography.
...
METADATA = {
    "name": "Slit Scan",
    "description": "Slit scan — temporal slit-scan photography.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "vfx",
    "tags": ['slit-scan', 'temporal', 'photography', 'time', 'warp'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'scan_width', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'scan_speed', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'direction', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'time_depth', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'warp', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'mix', 'type': 'float', 'default': 8.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float scan_width;  // Slit width
uniform float scan_speed;  // Scan speed
uniform float direction;  // Scan direction
uniform float time_depth;  // Time depth
...
void main() {
    ...
    float d = 0.0; float fb = 0.0; float fr = 8.0+(scan_speed/10.0)*10.0;
...
_PARAM_NAMES = ['scan_width', 'scan_speed', 'direction', 'time_depth', 'warp', 'mix']
_PARAM_DEFAULTS = {'scan_width': 3.0, 'scan_speed': 5.0, 'direction': 5.0, 'time_depth': 5.0, 'warp': 3.0, 'mix': 8.0}
