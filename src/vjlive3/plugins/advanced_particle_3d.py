"""
P6-P302: Advanced 3D particle system — CPU physics, GPU render, audio reactive.
...
METADATA = {
    ...
    "description": "Advanced 3D particle system — CPU physics, GPU render, audio reactive.",
    "version": "1.0.0",
    "plugin_type": "effect",
    "category": "particles",
    "tags": ['particles', '3d', 'physics', 'simulation', 'audio'],
    "priority": 1,
    "inputs": ["video_in"],
    "outputs": ["video_out"],
    "parameters": [{'name': 'particle_count', 'type': 'float', 'default': 7.0, 'min': 0.0, 'max': 10.0}, {'name': 'particle_size', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'emission_rate', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'lifetime', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'gravity', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'turbulence', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'bass_force', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'treble_sparkle', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'color_mode', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'glow', 'type': 'float', 'default': 3.0, 'min': 0.0, 'max': 10.0}, {'name': 'trail_length', 'type': 'float', 'default': 5.0, 'min': 0.0, 'max': 10.0}, {'name': 'feedback', 'type': 'float', 'default': 0.0, 'min': 0.0, 'max': 10.0}]
}
...
uniform float time;
uniform float u_mix;
uniform float particle_count;  // Max particles
uniform float particle_size;  // Particle size
uniform float emission_rate;  // Emit rate
uniform float lifetime;  // Particle lifetime
uniform float gravity;  // Gravity
uniform float turbulence;  // Turbulence
uniform float bass_force;  // Bass force
uniform float treble_sparkle;  // Treble sparkle
uniform float color_mode;  // Color from age/velocity/audio
uniform float glow;  // Glow
uniform float trail_length;  // Trail
...
_PARAM_NAMES = ['particle_count', 'particle_size', 'emission_rate', 'lifetime', 'gravity', 'turbulence', 'bass_force', 'treble_sparkle', 'color_mode', 'glow', 'trail_length', 'feedback']
_PARAM_DEFAULTS = {'particle_count': 7.0, 'particle_size': 5.0, 'emission_rate': 5.0, 'lifetime': 5.0, 'gravity': 5.0, 'turbulence': 3.0, 'bass_force': 5.0, 'treble_sparkle': 5.0, 'color_mode': 5.0, 'glow': 3.0, 'trail_length': 5.0, 'feedback': 0.0}
