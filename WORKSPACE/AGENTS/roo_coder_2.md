...
**Agent ID:** Roo Coder (2)
**Log file:** `WORKSPACE/COMMS/LOGS/roo_coder_2.md` — write ONLY here
...
Check `WORKSPACE/COMMS/DISPATCH.md` — look for rows with "Roo Coder (2)" in the Assigned To column.
Your current task chain: **Audio engine P1-A1 → A2 → A3 → A4** (A3/A4 blocked on research).
...
| **You (Roo Coder 2)** | Implementation details only, within the assigned spec |
...
10. Write completion note to WORKSPACE/COMMS/LOGS/roo_coder_2.md
