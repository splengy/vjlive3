...
[NEEDS RESEARCH]: How does VJLive3 handle concurrent access to `COMMS/DECISIONS.md`? Is there a locking mechanism or atomic write pattern in place?  
[NEEDS RESEARCH]: What is the schema of the concept data stored in the knowledge base (e.g., JSON structure)?  
[NEEDS RESEARCH]: Does the server support versioning of concepts or incremental updates?