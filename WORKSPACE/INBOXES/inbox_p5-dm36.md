# Task Assignment: P5-DM36

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P5-DM36`
> **Plugin:** volumetric_glitch
> **Spec:** `docs/specs/P5-P5-DM36_volumetric_glitch.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 5

## Mission

Port the `volumetric_glitch` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P5-P5-DM36_volumetric_glitch.md`
