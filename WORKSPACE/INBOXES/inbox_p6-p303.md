# Task Assignment: P6-P303

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P6-P303`
> **Plugin:** particles_3d
> **Spec:** `docs/specs/P6-P6-P303_particles_3d.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 6

## Mission

Port the `particles_3d` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P6-P6-P303_particles_3d.md`
