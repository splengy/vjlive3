# Task Assignment: P5-DM29

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P5-DM29`
> **Plugin:** sacred_geometry_datamosh
> **Spec:** `docs/specs/P5-P5-DM29_sacred_geometry_datamosh.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 5

## Mission

Port the `sacred_geometry_datamosh` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P5-P5-DM29_sacred_geometry_datamosh.md`
