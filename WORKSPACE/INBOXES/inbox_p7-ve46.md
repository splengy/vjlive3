# Task Assignment: P7-VE46

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE46`
> **Plugin:** living_fractal_consciousness
> **Spec:** `docs/specs/P7-P7-VE46_living_fractal_consciousness.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `living_fractal_consciousness` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE46_living_fractal_consciousness.md`
