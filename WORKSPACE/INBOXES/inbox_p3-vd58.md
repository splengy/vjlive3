# Task Assignment: P3-VD58

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P3-VD58`
> **Plugin:** Depth Mosh Nexus
> **Spec:** `docs/specs/P3-P3-VD58_Depth_Mosh_Nexus.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 3

## Mission

Port the `Depth Mosh Nexus` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P3-P3-VD58_Depth_Mosh_Nexus.md`
