# Task Assignment: P5-VE02

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P5-VE02`
> **Plugin:** analog_tv
> **Spec:** `docs/specs/P5-P5-VE02_analog_tv.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 5

## Mission

Port the `analog_tv` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P5-P5-VE02_analog_tv.md`
