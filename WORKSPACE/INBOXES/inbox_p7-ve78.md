# Task Assignment: P7-VE78

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE78`
> **Plugin:** vimana_hyperion_ultimate
> **Spec:** `docs/specs/P7-P7-VE78_vimana_hyperion_ultimate.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `vimana_hyperion_ultimate` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE78_vimana_hyperion_ultimate.md`
