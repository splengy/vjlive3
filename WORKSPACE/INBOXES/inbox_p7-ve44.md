# Task Assignment: P7-VE44

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE44`
> **Plugin:** hyperion
> **Spec:** `docs/specs/P7-P7-VE44_hyperion.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `hyperion` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE44_hyperion.md`
