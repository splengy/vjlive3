# Task Assignment: P7-VE19

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE19`
> **Plugin:** chroma_key
> **Spec:** `docs/specs/P7-P7-VE19_chroma_key.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `chroma_key` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE19_chroma_key.md`
