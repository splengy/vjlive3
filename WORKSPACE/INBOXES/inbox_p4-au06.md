# Task Assignment: P4-AU06

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P4-AU06`
> **Plugin:** cosmic_tunnel_datamosh
> **Spec:** `docs/specs/P4-P4-AU06_cosmic_tunnel_datamosh.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 4

## Mission

Port the `cosmic_tunnel_datamosh` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P4-P4-AU06_cosmic_tunnel_datamosh.md`
