# Task Assignment: P3-VD70

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P3-VD70`
> **Plugin:** Depth Video Projection
> **Spec:** `docs/specs/P3-P3-VD70_Depth_Video_Projection.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 3

## Mission

Port the `Depth Video Projection` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P3-P3-VD70_Depth_Video_Projection.md`
