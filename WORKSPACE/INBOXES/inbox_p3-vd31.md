# Task Assignment: P3-VD31

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P3-VD31`
> **Plugin:** Depth Contour Datamosh
> **Spec:** `docs/specs/P3-P3-VD31_Depth_Contour_Datamosh.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 3

## Mission

Port the `Depth Contour Datamosh` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P3-P3-VD31_Depth_Contour_Datamosh.md`
