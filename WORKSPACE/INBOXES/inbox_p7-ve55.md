# Task Assignment: P7-VE55

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE55`
> **Plugin:** r16_deep_mosh_studio
> **Spec:** `docs/specs/P7-P7-VE55_r16_deep_mosh_studio.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `r16_deep_mosh_studio` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE55_r16_deep_mosh_studio.md`
