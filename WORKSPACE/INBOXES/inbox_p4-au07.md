# Task Assignment: P4-AU07

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P4-AU07`
> **Plugin:** raymarched_scenes
> **Spec:** `docs/specs/P4-P4-AU07_raymarched_scenes.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 4

## Mission

Port the `raymarched_scenes` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P4-P4-AU07_raymarched_scenes.md`
