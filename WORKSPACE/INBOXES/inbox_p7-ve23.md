# Task Assignment: P7-VE23

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE23`
> **Plugin:** color
> **Spec:** `docs/specs/P7-P7-VE23_color.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `color` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE23_color.md`
