# Task Assignment: P5-DM26

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P5-DM26`
> **Plugin:** particle_datamosh_trails
> **Spec:** `docs/specs/P5-P5-DM26_particle_datamosh_trails.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 5

## Mission

Port the `particle_datamosh_trails` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P5-P5-DM26_particle_datamosh_trails.md`
