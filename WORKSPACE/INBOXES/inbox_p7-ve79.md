# Task Assignment: P7-VE79

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE79`
> **Plugin:** vimana_synth
> **Spec:** `docs/specs/P7-P7-VE79_vimana_synth.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `vimana_synth` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE79_vimana_synth.md`
