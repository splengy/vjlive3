# Task Assignment: P3-VD51

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P3-VD51`
> **Plugin:** Depth Groovy Datamosh
> **Spec:** `docs/specs/P3-P3-VD51_Depth_Groovy_Datamosh.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 3

## Mission

Port the `Depth Groovy Datamosh` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P3-P3-VD51_Depth_Groovy_Datamosh.md`
