# Task Assignment: P6-GE17

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P6-GE17`
> **Plugin:** vcv_video_generators
> **Spec:** `docs/specs/P6-P6-GE17_vcv_video_generators.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 6

## Mission

Port the `vcv_video_generators` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P6-P6-GE17_vcv_video_generators.md`
