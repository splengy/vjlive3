# Task Assignment: P7-VE59

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P7-VE59`
> **Plugin:** rutt_etra_scanline
> **Spec:** `docs/specs/P7-P7-VE59_rutt_etra_scanline.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 7

## Mission

Port the `rutt_etra_scanline` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P7-P7-VE59_rutt_etra_scanline.md`
