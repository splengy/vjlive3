# Task Assignment: P6-P304

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P6-P304`
> **Plugin:** shadertoy_particles
> **Spec:** `docs/specs/P6-P6-P304_shadertoy_particles.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 6

## Mission

Port the `shadertoy_particles` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P6-P6-P304_shadertoy_particles.md`
