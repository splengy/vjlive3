# Task Assignment: P6-GE06

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P6-GE06`
> **Plugin:** fractal_generator
> **Spec:** `docs/specs/P6-P6-GE06_fractal_generator.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 6

## Mission

Port the `fractal_generator` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P6-P6-GE06_fractal_generator.md`
