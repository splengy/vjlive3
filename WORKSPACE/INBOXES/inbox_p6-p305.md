# Task Assignment: P6-P305

> **From:** Manager (ROO CODE)
> **To:** Implementation Engineer (Alpha)
> **Task ID:** `P6-P305`
> **Plugin:** vibrant_retro_styles
> **Spec:** `docs/specs/P6-P6-P305_vibrant_retro_styles.md`
> **Priority:** P0 (Critical)
> **Phase:** Phase 6

## Mission

Port the `vibrant_retro_styles` effect from the legacy codebases into VJLive3's clean architecture. This is a **bespoke** plugin port — treat it as a unique snowflake, not a batch job.

## Immediate Actions

1. Read the specification file: `docs/specs/P6-P6-P305_vibrant_retro_styles.md`
